...
import { useEditTodo } from "@/app/jotai/stores/sync-store/sync-store";
      ...
      <CustomDialog open={open} onOpenChange={setOpen}>
        <div className="flex flex-col gap-4">
          <header>
            ...
            <p className="text-sm text-muted-foreground">Change the task details below.</p>
          </header>

          <form onSubmit={handleEdit} className="space-y-4 mt-4">
            <div className="space-y-2">
              <Label htmlFor="edit-name">Name</Label>
              <Input id="edit-name" type="text" value={editName} onChange={(e) => setEditName(e.target.value)} required autoFocus />
            </div>
