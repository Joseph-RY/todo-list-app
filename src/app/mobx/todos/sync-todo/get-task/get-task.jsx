...
import todoStore from "@/app/mobx/store"; // подстрой путь под себя
...
const GetTask = observer(({ taskId }) => {
  const [open, setOpen] = useState(false);

  // Получаем task напрямую из MobX store по ID
  const task = todoStore.syncTodos.find((t) => t.id === taskId);
